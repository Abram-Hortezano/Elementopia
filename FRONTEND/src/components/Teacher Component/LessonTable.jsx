...
export default function BasicTable() {
  ...
  return (
    <Box p={2} sx={{ backgroundColor: "#121212", minHeight: "100vh" }}>
      ...
      <TableContainer
        component={Paper}
        sx={{ backgroundColor: "#1f1f2e", maxHeight: 500, borderRadius: 2 }}
      >
        <Table stickyHeader>
            ...
            {loading ? (
              ...
              lessons.map((lesson) => (
                <TableRow
                  key={lesson.id}
                  hover
                  sx={{ "&:hover": { backgroundColor: "#2b2b3f" } }}
                >
                  ...
                  <TableCell align="center" sx={{ color: "#cccccc" }}>
                    {lesson.room || "N/A"}
                  </TableCell>
                  <TableCell align="center" sx={{ color: "#cccccc" }}>
                    {lesson.numberOfStudents ?? "N/A"}
                  </TableCell>
