          ...
          {selectedElementInfo ? (
            <Box sx={{ fontSize: "13.5px", lineHeight: 1.6 }}>
              ...
              <Typography sx={{ marginBottom: 0.5 }}>
                ...
                {selectedElementInfo.atomic_mass || "N/A"}
              </Typography>
              <Typography sx={{ marginBottom: 0.5 }}>
                <strong>Atomic Number:</strong>{" "}
                {selectedElementInfo.number || "N/A"}
              </Typography>
              <Typography sx={{ marginBottom: 0.5 }}>
                <strong>Category:</strong>{" "}
                {selectedElementInfo.category || "N/A"}
              </Typography>
              <Typography sx={{ marginBottom: 0.5 }}>
              ...
              <Typography sx={{ marginBottom: 0.5 }}>
                ...
                {selectedElementInfo.boil
                  ? `${selectedElementInfo.boil} K`
                  : "N/A"}
              </Typography>
              <Typography sx={{ marginBottom: 0.5 }}>
                <strong>Melting Point:</strong>{" "}
                {selectedElementInfo.melt
                  ? `${selectedElementInfo.melt} K`
                  : "N/A"}
              </Typography>
              <Typography sx={{ marginBottom: 0.5 }}>
                <strong>Density:</strong>{" "}
                {selectedElementInfo.density
                  ? `${selectedElementInfo.density} g/cm³`
                  : "N/A"}
              </Typography>
