  ...
  useEffect(() => {
    const loadAchievements = async () => {
      try {
        ...
        const earnedSet = new Set(achievements.map((a) => a.codeName));
    ...
    <Box>
      ...
      >
        <Typography variant="body2">
          <strong>Teacher Preview:</strong> All achievements are shown as
          unlocked for preview purposes. This view helps you understand what
            ...
            >
              <Box>
                ...
                <Typography sx={{ color: "#b0b0b0" }}>
                  Total achievements available for students
                </Typography>
              </Box>
      ...
      >
        ...
        <Typography variant="body2" sx={{ color: "#b0b0b0" }}>
          This preview shows all achievements that students can earn. Use this
          information to:
        </Typography>
