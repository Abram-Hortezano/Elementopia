    ...
    >
      ...
      >
          ...
          <Grid container alignItems="center" spacing={2}>
            ...
            <Grid item xs>
              <Box>
                <Typography
                  variant="h4"
                  sx={{ color: "#00bcd4", fontWeight: "bold", mb: 1 }}
                >
                  Teacher Preview Dashboard
                </Typography>
                <Typography variant="body1" sx={{ color: "#b0e0e6" }}>
                  View all achievements and discoveries that students can
                  unlock. This preview shows the complete learning journey.
                </Typography>
              </Box>
            </Grid>
            <Grid item>
            ...
            >
              <CardContent>
                <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                  <EmojiEventsIcon
                    sx={{ color: "#4caf50", mr: 2, fontSize: 30 }}
                  />
                ...
                >
                  {teacherStats.unlockedAchievements}/
                  {teacherStats.totalAchievements}
                </Typography>
                <LinearProgress
                  variant="determinate"
                  value={
                ...
                <Typography
                  variant="caption"
                  sx={{ color: "#b0b0b0", mt: 1, display: "block" }}
                >
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            >
              <CardContent>
                ...
                >
                  {teacherStats.unlockedDiscoveries}/
                  {teacherStats.totalDiscoveries}
                </Typography>
                <LinearProgress
                  variant="determinate"
                  value={
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            >
              <CardContent>
                <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                  <CheckCircleIcon
                    sx={{ color: "#9c27b0", mr: 2, fontSize: 30 }}
                  />
          ...
          >
              ...
              sx={{
                ...
                bgcolor:
                  activeTab === "achievements"
                    ? "linear-gradient(135deg, #00bcd4 0%, #008ba3 100%)"
                    : "transparent",
                color: activeTab === "achievements" ? "white" : "#00bcd4",
                borderRadius: "12px",
                border:
                  activeTab === "achievements" ? "none" : "2px solid #00bcd4",
                boxShadow:
                  activeTab === "achievements"
                    ? "0px 0px 20px rgba(0, 188, 212, 0.7)"
                    : "none",
                "&:hover": {
                  bgcolor:
                    activeTab === "achievements"
                      ? "linear-gradient(135deg, #008ba3 0%, #006679 100%)"
                      : "rgba(0, 188, 212, 0.1)",
            ...
            <Button
              ...
              sx={{
                ...
                borderRadius: "12px",
                border:
                  activeTab === "discovery" ? "none" : "2px solid #2196f3",
                boxShadow:
                  activeTab === "discovery"
                    ? "0px 0px 20px rgba(33, 150, 243, 0.7)"
                    : "none",
                "&:hover": {
                  bgcolor:
                    activeTab === "discovery"
          ...
          {activeTab === "achievements" ? (
            <>
              <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
                <EmojiEventsIcon
                  sx={{ color: "#00bcd4", mr: 2, fontSize: 32 }}
                />
                <Typography
                  variant="h4"
        ...
        >
          ...
          >
            Teacher Preview Mode • All content visible for educational planning
