...
export default function MapTree() {
  ...
  useEffect(() => {
    localStorage.setItem(
      "completedNodes",
      JSON.stringify(Array.from(completedNodes))
    );
  }, [completedNodes]);
    ...
    <div className="Map-Container">
      <div className="Node-Container">
        {nodes.map((node) => {
          ...
          const isUnlocked =
            prerequisites.every((p) => completedNodes.has(p)) || node.id === 1;
